import type Reflector from '@App/reflector.js'
import type Rotor from '@App/rotor.js'
export default class Enigma {
  ...
  private encodeChar (input: string): string {
  ...
  positionToChar (outputPosition: number): string {
    return String.fromCharCode(outputPosition + 65)
  }

  charToPosition (input: string): number {
